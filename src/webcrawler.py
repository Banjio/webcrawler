...
class WebCrawler:
    ...
    def __init__(self, start_url: str, max_depth: int = 2, max_time: int = 300, verbose: bool = True, **soup_find_kwargs):
    ...
    def crawl(self) -> Dict[str, Any]:
        ...
        self.crawl_stack.append((self.start_url, 0))
            ...
            if success and depth < self.max_depth:
                ...
                for link in reversed(child_links):
                    if link not in self.visited_urls:
                        self.crawl_stack.append((link, depth + 1))
...
def main():
    ...
    crawler = WebCrawler(start_url, max_depth=2, max_time=max_time, **soup_find_kwargs)
